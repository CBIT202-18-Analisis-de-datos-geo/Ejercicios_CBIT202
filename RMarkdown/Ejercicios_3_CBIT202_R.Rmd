...
Pregunta 2: ¿Y la distribución de los tamaños de parche como es por uso? (Pista: ocupe geom_boxplot con outliers = F)
...
Pregunta 4: ¿Para bosques, en que combinación de cobertura y tipo forestal hay mayor número de parches? (Pista: ocupe geom_count())
...
**Bonus** Al grafico anterior agregele un punto con la media.
